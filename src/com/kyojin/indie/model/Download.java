...
public class Download extends Request {
	...
	public String generatecanonicalTimestamp() {
		return "<des:PeticionDescargaMasivaTercerosEntrada xmlns:des=\"http://DescargaMasivaTerceros.sat.gob.mx\">" +
                "<des:peticionDescarga IdPaquete=\"" + this.idPackage + "\" RfcSolicitante=\"" + this.rfcApplicant + "></des:peticionDescarga>" +
	...
	public StringBuilder generateRequest() throws CertificateEncodingException {
		...
		return this.request
				...
				.append("<des:peticionDescarga IdPaquete=\"" + this.idPackage + "\" RfcSolicitante=\"" + this.rfcApplicant + "\">")
